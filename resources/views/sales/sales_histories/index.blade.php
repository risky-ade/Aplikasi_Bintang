      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between mb-3">
            <form action="{{ route('histori-harga-jual.destroy-by-date') }}" method="POST" class="form-delete-date">
              @csrf
              @method('DELETE')
              <input type="hidden" name="tanggal_awal" value="{{ request('tanggal_awal') }}">
              <input type="hidden" name="tanggal_akhir" value="{{ request('tanggal_akhir') }}">
              <input type="hidden" name="produk_id" value="{{ request('produk_id') }}">
              <input type="hidden" name="pelanggan" value="{{ request('pelanggan') }}">
          ...
          <form action="{{ route('histori-harga-jual.destroy-selected') }}" method="POST" id="form-delete-selected" class="form-delete-selected">
            @csrf
            @method('DELETE')
